CREATE TABLE pokemon (pokenumber INT NOT NULL PRIMARY KEY, pokename TEXT, picture_url TEXT);
INSERT INTO pokemon (pokenumber, pokename, picture_url) values (1, 'Bulbasaur', 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png');
